...
//
// class Cart {
//   var get cartMedicineIDs => {
//     int length = quantities.length;
// List<int> result = List.filled(this.Medicines.length , 0);
// return result;
//   // List<int> result = List.filled(MedicineIDs.length, 0);
//   // for (int index = 0; index < MedicineIDs.length; ++index) {
//   // result[index] = MedicineIDs[index].id;
//   // }
//   // return result;
//   };
